...
export default function InstructorTable({ data, columns, totalData , idCenter }) {
  ...
  useEffect(() => {
   setDatad(data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage))
  ...
  const OnUpdate = (id) =>  {
    navigate(`/UpdateInstructor/${id}/${idCenter}`);
  }
